...
for (i in seq(1, length(time_periods), by = 2)) {
  ...
  save(results, 
       file = here(paste0("output/cluster_results/cluster_results_inst/FE_Clust_EA_inst_",
  ...
  ggsave(here(paste0("output/dendrograms/dendrograms_inst/FE_Clust_EA_inst_", 
                     start_year, "_", 
                     end_year, ".png")), 
         dendo, 
...
ggsave(here(paste0("output/sankeys/sankeys_inst/FE_Sankey_EA_inst_", 
                   time_periods[1], "_", 
...
ggsave(here("output/cluster_numbers/cluster_numbers_inst/step_plot_inst.pdf"), 
       step_plot,
       width = 6.5, height = 4, dpi = 300, units = "in", bg = "white")

ggsave(here("output/cluster_numbers/cluster_numbers_inst/step_plot_inst.svg"), 
       step_plot,
       width = 6.5, height = 4, dpi = 300, units = "in", bg = "white")
...
ggsave(here("output/cluster_numbers/cluster_numbers_inst/gap_stat_plot_inst.pdf"),
       gap_stat_plot,
       width = 6.5, height = 4, dpi = 300, units = "in", bg = "white")

ggsave(here("output/cluster_numbers/cluster_numbers_inst/gap_stat_plot_inst.svg"),
       gap_stat_plot,
       width = 6.5, height = 4, dpi = 300, units = "in", bg = "white")
...
ggsave(here("output/cluster_numbers/cluster_numbers_inst/elbow_plot_inst.pdf"),
       elbow_plot,
       width = 6.5, height = 4, dpi = 300, units = "in", bg = "white")

ggsave(here("output/cluster_numbers/cluster_numbers_inst/elbow_plot_inst.svg"),
       elbow_plot,
       width = 6.5, height = 4, dpi = 300, units = "in", bg = "white")
