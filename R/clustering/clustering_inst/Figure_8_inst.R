...
for (i in seq_along(variable_list)) {
  ...
  save(results, 
       file = here(paste0("output/cluster_results/cluster_results_inst/FE_Clust_EA_selection_inst_",
                          var_set_name, ".RData")))
  ...
  ggsave(here(paste0("output/dendrograms/dendrograms_inst/FE_Clust_EA_selection_inst_", 
                     var_set_name, ".png")), 
         dendo, 
...
ggsave(here(paste0("output/FE_Sankey_EA_selection_inst.pdf")), 
       sankey_variable_selection, 
       width = 11, height = 6, dpi = 300, bg = "white")

ggsave(here(paste0("output/FE_Sankey_EA_selection_inst.svg")), 
       sankey_variable_selection, 
       width = 11, height = 6, dpi = 300, bg = "white")